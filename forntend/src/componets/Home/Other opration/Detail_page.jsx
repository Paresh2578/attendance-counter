    ...
    <div>
      ...
      >
        ...
        <div className='m-3'>
          ...
          <div className='mb-2 subjectName'><span className='h4 child_style'>Date : </span> {data.date}</div>
          <div className='mb-2 subjectName'><span className='h4 child_style'>Time : </span> {data.time}</div>
